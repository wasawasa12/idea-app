...
# ALLOWED_HOSTS = ['*']  # 許可する接続先?これはどこでも可
...
INSTALLED_APPS = [
    ...
    'idea.apps.IdeaConfig',  # 追加
    'standard.apps.StandardConfig',  # 追加
    'matrix.apps.MatrixConfig',  # アイディア評価マトリクス
    'refine.apps.RefineConfig',  # アイディア精緻化
    'reflect.apps.ReflectConfig',  # 統括的分析(振り返り)
    'retry.apps.RetryConfig',  # 再試行の設計
